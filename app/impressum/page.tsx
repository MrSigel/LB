...
export default function ImpressumPage() {
  return (
    <LegalLayout title="Impressum">
      ...
      <p>Umsatzsteuer-ID: BG206546638</p>
      ...
      <p>
        ...
        den allgemeinen Gesetzen verantwortlich. Nach Artikel 8 der Verordnung
        (EU) 2022/2065 (Gesetz über digitale Dienste) sind wir als
